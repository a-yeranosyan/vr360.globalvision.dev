				...
				<div id="open-add-hot" class="form-inline" style="display: none;">
					<div class="form-group">
						<div class="hotspot-types">
							<?php echo Vr360Layout::getInstance()->fetch('krpano.hotspots'); ?>
						</div>
						...
						<div class="hotspot-type-forms">
							...
							<?php echo Vr360Layout::getInstance()->fetch('krpano.hotspots.scene'); ?>
						</div>
					</div>
				</div>
...
<div id="pano">
	<script type="text/javascript">
        ...
        function addTooltip() {
            disableButton(['#add_Tooltip', '#add_Modal', '#add_text', '#add_image', '#add_video', '#add_link', '#savehotspots']);
            $("#Tooltip_div").show();
        }
